...
<head>
    ...
    <script>
        tailwind.config = {
            ...
            theme: {
                extend: {
                    fontFamily: {
                        // Poppins sudah di link rel="stylesheet"
    ...
    <style>
        ...
        .main-container {
            ...
            box-shadow: 0 25px 50px rgba(0, 0, 0, 0.7), 0 0 15px rgba(102, 181, 232, 0.2) inset, 0 0 5px rgba(0, 0, 0, 0.5);
        ...
        .result-error {
            border: 1px solid var(--tw-color-accent-purple);
...
<body class="bg-gray-100 text-gray-800 dark:bg-gray-900 dark:text-white bg-fixed transition-colors duration-300">
