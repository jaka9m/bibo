  ...
  async fetch(request, env, ctx) {
    ...
    <body class="bg-gray-900 text-white min-h-screen flex flex-col items-center">
      ...
      <div id="nav-buttons-container" class="w-full max-w-5xl flex justify-center gap-4 mb-8">
        ...
        <button onclick="navigateTo('/sub/0')" class="px-4 py-2 rounded-lg text-white font-semibold nav-btn-center action-btn hover:opacity-80 transition-opacity">Create VPN</button>
        <button onclick="navigateTo('/converter')" class="px-4 py-2 rounded-lg text-white font-semibold nav-btn-center btn-gradient hover:opacity-80 transition-opacity">Converter</button>
        <button onclick="navigateTo('/kuota')" class="px-4 py-2 rounded-lg text-white font-semibold nav-btn-center action-btn hover:opacity-80 transition-opacity">Cek Kuota</button>
